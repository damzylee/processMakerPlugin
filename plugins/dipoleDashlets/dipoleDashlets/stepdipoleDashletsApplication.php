...
try {
  ...
  $oHeadPublisher->addContent("dipoleDashlets/stepdipoleDashletsApplication"); //Adding a html file .html.
  $oHeadPublisher->addExtJsScript("dipoleDashlets/stepdipoleDashletsApplication", false); //Adding a javascript file .js
