...
class dashletdipoleDashlets implements DashletInterface
{
  const version = '1.0';
  ...
  public function render($width = 300)
  {
    ...
    ///////
    $dashletView = new dashletdipoleDashletsView($arrayUser, $this->note);
...
class dashletdipoleDashletsView extends Smarty
{
  private $smarty;
  ...
  public function __construct($u, $n)
  {
    ...
    $this->smarty->templateFile = PATH_PLUGINS . "dipoleDashlets" . PATH_SEP . "views" . PATH_SEP . "dashletdipoleDashlets.html";
  }
