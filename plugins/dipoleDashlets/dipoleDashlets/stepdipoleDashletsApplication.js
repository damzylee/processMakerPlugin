Ext.namespace("stepdipoleDashlets");

stepdipoleDashlets.application = {
  init:function(){
    storeApplicationProcess = function () {
      ...
      Ext.Ajax.request({
        url: "../dipoleDashlets/stepdipoleDashletsApplicationAjax",
        method: "POST",
...
Ext.onReady(stepdipoleDashlets.application.init, stepdipoleDashlets.application);